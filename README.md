...
- [Обновление до новых выпусков](#обновление-до-новых-выпусков)
...
- [Поддерживаемые языковые функции и полифилы](#поддерживаемые-языковые-функции-и-полифилы)
- [Подсветка синтаксиса в редакторе](#подсветка-синтаксиса-в-редакторе)
- [Отображение вывода Lint в редакторе](#отображение-вывода-lint-в-редакторе)
- [Отладка в редакторе](#отладка-в-редакторе)
- [Автоматическое форматирование кода](#автоматическое-форматирование-кода)
- [Изменение страницы `<title>`](#изменение-страницы-`<title>`)
- [Установка зависимости](#установка-зависимости)
- [Импорт компонента](#импорт-компонента)
- [Разделение кода](#разделение-кода)
- [Добавление таблицы стилей](#добавление-таблицы-стилей)
- [Постобработка CSS](#постобработка-css)
- [Добавление препроцессора CSS (Sass, Less etc.)](#добавление-препроцессора-css-sass-less-etc)
- [Добавление изображений, шрифтов и файлов](#добавление-изображений,-шрифтов-и-файлов)
- [Использование папки `public`](#использование-папки-`public`)
  - [Изменение HTML](#изменение-html)
  - [Добавление активов вне модульной системы](#добавление-активов-вне-модульной-системы)
  - [Когда использовать публичную папку](#когда-использовать-публичную-папку)
- [Использование глобальных переменных](#использование-глобальных-переменных)
- [Добавление Bootstrap](#добавление-bootstrap)
  - [Использование настраиваемой темы](#использование-настраиваемой-темы)
- [Добавление потока](#добавление-потока)
- [Добавление маршрутизатора](#добавление-маршрутизатора)
- [Добавление пользовательских переменных среды](#добавление-пользовательских-переменных-среды)
  - [Ссылка на переменные среды в HTML](#ссылка-на-переменные-среды-в-html)
  - [Добавление временных переменных среды в вашу оболочку](#добавление-временных-переменных-среды-в-вашу-оболочку)
  - [Добавление переменных среды разработки в .env](#добавление-переменных-среды-разработки-в-.env)
  - [Расширение переменных окружения в `.env`](#расширение-переменных-окружения-в-env)
- [Могу ли я использовать декораторы?](#могу-ли-я-использовать-декораторы?)
- [Получение данных запросами AJAX](#получение-данных-запросами-ajax)
- [Интеграция с API Backend](#интеграция-с-api-backend)
  - [Node](#node)
  - [Ruby on Rails](#ruby-on-rails)
- [Проксирование запросов API в разработке](#проксирование-запросов-api-в-разработке)
...
## Поддерживаемые языковые функции и полифилы
...
## Добавление препроцессора CSS (Sass, Less etc.)
...
### Добавление активов вне модульной системы
...
### Когда использовать публичную папку
...
#### Какие ещё файлы `.env` можно использовать?
...
#### Расширение переменных окружения в `.env`
...
## Получение данных запросами AJAX
